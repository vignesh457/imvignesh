...
export default function CustomProjectCardSkeleton() {
  return (
    <div className="h-[460px] w-[90%] md:w-[50%] flex flex-col rounded-xl overflow-hidden bg-neutral-950 gap-4 border border-neutral-800">
      
      {/* Image Skeleton */}
      <div className="relative w-full h-[40%] md:h-[50%] bg-neutral-800 rounded-md p-4">
      ...
      <div className="flex flex-col p-4 gap-2 h-[60%] md:h-[50%]">
