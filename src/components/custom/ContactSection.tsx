...
export default function ContactSection() {
  return (
    ...
    >
      <div className="relative flex flex-col justify-center items-center w-[95%] md:w-[40%] h-[320px] bg-neutral-900 rounded-xl overflow-hidden border border-neutral-800 gap-2 p-4 transition-all duration-500">
